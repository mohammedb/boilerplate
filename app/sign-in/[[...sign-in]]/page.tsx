      ...
      <div className="min-h-screen flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-serif text-[#F9F9F9] mb-2">Welcome Back</h1>
            <p className="text-[#A0A0A0]">Sign in to continue to your dashboard</p>
          </div>
          <SignIn 
            appearance={{
              elements: {
          ...
          <div className="mt-6 text-center">
            <p className="text-[#A0A0A0] text-sm">
              ...
              <Link href="/sign-up" className="text-[#E8FC6B] hover:underline">
                Sign up
              </Link>
            </p>
          </div>
